...
% Sheet A: b = 0.25
theta_0_b1 = A(1:17,2);
theta_15_b1 = A(1:17,3);
theta_30_b1 = A(1:17,4);
theta_45_b1 = A(1:17,5);
theta_60_b1 = A(1:17,6);
theta_75_b1 = A(1:17,7);
theta_90_b1 = A(1:17,8);

% Sheet B: b = 0.5
theta_0_b2 = B(1:17,2);
theta_15_b2 = B(1:17,3);
theta_30_b2 = B(1:17,4);
theta_45_b2 = B(1:17,5);
theta_60_b2 = B(1:17,6);
theta_75_b2 = B(1:17,7);
theta_90_b2 = B(1:17,8);

% Sheet C: b = 0.75
theta_0_b3 = C(1:17,2);
theta_15_b3 = C(1:17,3);
theta_30_b3 = C(1:17,4);
theta_45_b3 = C(1:17,5);
theta_60_b3 = C(1:17,6);
theta_75_b3 = C(1:17,7);
theta_90_b3 = C(1:17,8);
